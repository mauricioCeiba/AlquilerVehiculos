...
export class ListarAlquilerComponent implements OnInit {
  ...
  public irACrearDevolucion(alquiler: Alquiler) {
    this.router.navigate(["/devolucion/crear/"], {
      queryParams: {
        id: alquiler.id,
        vehiculosId: alquiler.vehiculosId,
        usuariosId: alquiler.usuariosId,
        cantidadDiasAlquiler: alquiler.cantidadDiasAlquiler,
        valorTotalParcial: alquiler.valorTotalParcial,
